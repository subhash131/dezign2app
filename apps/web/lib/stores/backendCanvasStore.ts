...
interface BackendCanvasState {
  ...
  activeConfigItem: { type: 'endpoint' | 'event' | 'task' | 'searchIndex', id: string, nodeId: string } | null;
  setActiveConfigItem: (item: { type: 'endpoint' | 'event' | 'task' | 'searchIndex', id: string, nodeId: string } | null) => void;
